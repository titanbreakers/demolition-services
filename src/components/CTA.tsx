      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-4xl md:text-6xl text-primary-foreground mb-6">
            {t.cta?.readyToStart || (locale === 'en' ? 'READY TO START?' : 'KLAAR OM TE STARTEN?')}
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              {t.cta?.requestQuote || (locale === 'en' ? 'Request Quote' : 'Offerte Aanvragen')}
            ...
            >
              ...
              {locale === 'en'
                ? 'Call Direct: 06-12345678'
                : t.cta?.callDirect || 'Bel Direct: 06-12345678'}
            </a>
          </div>
        </div>
      </div>
