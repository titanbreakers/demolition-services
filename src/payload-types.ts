...
export interface Service {
  ...
  description?: string | null;
  /**
   * Lucide icon name (e.g., Hammer, Shield, Recycle)
   */
  icon?: string | null;
...
export interface Project {
  ...
  description?: string | null;
  image?: (string | null) | Media;
  category?: ('demolition' | 'asbestos' | 'renovation' | 'environmental') | null;
...
export interface SiteSetting {
  ...
  logo?: {
    /**
     * Letter shown in logo square (e.g., T for TitanBrekers)
     */
    letter?: string | null;
    /**
     * Optional logo image (if not set, letter logo will be used)
     */
    image?: (string | null) | Media;
  };
  contact?: {
...
export interface HomePage {
  ...
  hero?: {
    ...
    features?:
      | {
          /**
           * Lucide icon name (e.g., Clock, Shield, Award)
           */
          icon?: string | null;
          title: string;
          description?: string | null;
...
export interface AboutPage {
  ...
  values?:
    | {
        /**
         * Lucide icon name (e.g., Shield, Target, Heart, Users)
         */
        icon: string;
        title: string;
        description: string;
